...
export const COMPANY_INFO = {
  ...
  serviceAreas: ['Indiranagar', 'Koramangala', 'Jayanagar', 'Whitefield', 'Sadashivanagar', 'HSR Layout'],
  phone: '+91 9693821174',
  email: 'hello@ardan.in',
...
export const TEAM_MEMBERS: TeamMember[] = [
  {
    ...
    bio: 'Architectural background with 15 years experience directing residential transformations across Bengaluru.',
